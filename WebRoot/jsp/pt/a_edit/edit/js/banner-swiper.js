//var text = document.getElementById("yulanHtml");
//app.innerHTML = text.getAttribute("value");
var $appField = document.querySelectorAll(".app-field");
...
function bannerRoll(ed, i) {
    ...
    var mySwiper = new Swiper ('.swiper' + i + '', {
        ...
        // 如果需要分页器
        pagination:ed.querySelector(".swiper-pagination"),
  }) 
}
