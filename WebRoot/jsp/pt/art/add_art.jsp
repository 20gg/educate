  ...
  <body>
     ...
     <table class="table " style="width: 94%; margin-left: 3%; margin-top: 20px; font-size:14px; cursor: hand;
     	...
     	<tr>
     		...
     		<td style="width: 90%;">
     			 <select id="recommend" class="form-control" style="width: 400px;">
     				<option value="1">热荐</option>
     				<option value="0">不热荐</option> 
     			</select>
     		</td>
     	</tr>
     	<tr>
     		...
     		<td style="width: 90%;">
     			 <input type="text" id="title" class="form-control" style="width: 400px;" >
     		</td>
     	</tr>
     	<tr>
     	...
     	<tr>
     		...
     		<textarea id="context" name="content1" style="width: 800px" type="text/plain"></textarea>
...
function commit(){
	...
	$.ajax({
 		type:"post",
 		url: pt_path +"/article/add_art.do",
 		dataType:"json",
 		data:{"sort":sort,"recommend":recommend,"title":title,"img":img,"context":context},
 		success: function(data){
