  ...
  <body style="overflow-x: hidden;">
   		...
   		<div class="top_box" >
			...
			<div class="row" >
				...
				<input type="text" placeholder="输入验证码"   id="my_code" style="border: none;height: 40px;font-size: 14px;width: 100px;" onblur="is_true();"/>
				</div>
			...
			<div class="row" >
				...
				<div class="col1">到期时间</div>
				<div class="col2">
				<input  style="border: none;height: 30px; font-size: 14px;padding-top: 18px;background-color: #fff;" value="${vip_order.safe_date}" id="safe_date" readonly="readonly">
				</div>
				<div class="clearfix"></div>
			</div>
			...
			<div class="button" >
				<span id="join_button" onclick="join_vip();" >续费VIP</span>
			</div>
...
//var openid="ok4o7wRQUQkVPK9I7B6u2sn5jhno";
...
function join_vip() {
		...
		if(job==null||job==""){
		 ...
		 $.ajax({
			type:"post",
			dataType:"json",
			url:pt_path+"wxpay/xf_vip.do",
			data : {"openid":openid,"name":name,"phone":phone,"company":company,"job":job,"safe_date":safe_date,"code":code},
			success : function(data){
				
				if(data[0].back_code == 1){
					 
					into_pay(data[0].order_id,3);
