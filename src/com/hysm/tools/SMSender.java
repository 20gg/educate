...
public class SMSender
{
	...
	public static String sendSM(String phone,String code) 
	{
		...
		NameValuePair[] data ={ new NameValuePair("Uid", "SHANGYIJIU"),new NameValuePair("Key", "b8bbd8048d407ac15c13"),new NameValuePair("smsMob",phone),new NameValuePair("smsText",code)};
	...
	public static String sendSM_link(String phone,String link) 
	{
		...
		PostMethod post = new PostMethod("http://utf8.sms.webchinese.cn/");
		post.addRequestHeader("Content-Type","application/x-www-form-urlencoded;charset=utf8");//在头文件中设置转码
		NameValuePair[] data ={ new NameValuePair("Uid", "SHANGYIJIU"),new NameValuePair("Key", "b8bbd8048d407ac15c13"),new NameValuePair("smsMob",phone),new NameValuePair("smsText",link)};
		post.setRequestBody(data);
...
/*		String urlone="http://hprpt2.eucp.b2m.cn:8080/sdkproxy/regist.action";
		...
		*/
		...
		String param="cdkey=8SDK-EMY-6699-REUSO&password=499307&phone="+phone+"&message="+code;
...
//		int sss=(Integer)s.get("error");
	...
	public static void main(String[] args) throws HttpException, IOException {
			...
			String phone="15380915369";

			String code="【商e久】(供货商)邀请码：fwfwfw";
