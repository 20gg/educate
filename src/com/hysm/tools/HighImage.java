...
public class HighImage {
  ...
  public static void main(String[] args) {
      HighImage is = new HighImage();
      System.out.println("3333333333");
      try {
          is.saveImageAsJpg("D:/pics/sunset.jpg", "D:/pics/convert1.jpg", 300, 300);
  ...
  // 文件夹路径，图片所在文件夹名，图片名，宽，高         /img/zhengjian    ys
  public void  handleImage(String p_path,String parentDir,String fileName,int formatWideth, int formatHeight) throws Exception {
      ...
      File saveFile = new File(p_path+"/"+parentDir+"/"+fileName);
      File fromFile = new File(p_path+"/"+fileName);
